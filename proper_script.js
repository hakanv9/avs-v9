...
<head>
    ...
    <!-- SEO-2: KOD-6 &amp; encode düzeltildi -->

    <title>Yasal Bilgiler — Gizlilik &amp; Koşullar | AVS&amp;V9</title>

    <meta name="description" content="AVS&amp;V9 Gizlilik Politikasııı ve Kullanım Koşulları.">

    <link rel="icon" type="image/png" href="resimler/site-ikonu.png">
...
<body class="subpage-body">
    ...
    <nav class="navbar" aria-label="Ana gezinti">

        <!-- KOD-6: Logo &amp; encode düzeltildi -->

        <a class="logo" href="index.html">AVS&amp;V9</a>



        <button class="hamburger" type="button" aria-label="Menüyü aç/kapat" aria-expanded="false"

            aria-controls="nav-links-yasal">
        ...
        <ul class="nav-links" id="nav-links-yasal">

            <li><a href="index.html#anasayfa" data-i18n="nav.home">Ana Sayfa</a></li>

            <li><a href="index.html#projeler" data-i18n="nav.projects">Projelerim</a></li>

            <li><a href="index.html#sosyal-medya" data-i18n="nav.social">Sosyal Medya</a></li>

            <li><a href="index.html#hakkinda" data-i18n="nav.about">Hakkında</a></li>

            <li><a href="index.html#iletisim" data-i18n="nav.contact">İletişim</a></li>

            <li><a href="sss.html" data-i18n="nav.faq">SSS</a></li>

            <li><a href="yasal.html" class="active" data-i18n="nav.legal">Yasal</a></li>
        ...
        <div class="nav-controls">
            ...
            <button class="nav-ctrl-btn" id="themeToggle" aria-label="Temayı değiştir">

                <span id="themeIcon">🌙</span>

            </button>

            <button class="nav-ctrl-btn" id="langToggle" aria-label="Dili değiştir">

                <span>🌐</span><span id="langLabel">TR</span>
    ...
    <main class="subpage-main">
        ...
        <div class="subpage-hero">
            ...
            <h1 data-i18n="legal.page.title">Yasal Bilgiler</h1>

            <p data-i18n="legal.page.sub">Gizlilik Politikamız ve Kullanım Koşullarımız.</p>
        ...
        <div class="legal-tabs" role="tablist">
            ...
            <button class="legal-tab-btn active" data-tab="panel-privacy" role="tab" aria-selected="true"

                aria-controls="panel-privacy" data-i18n="legal.tab.privacy">

                🔒 Gizlilik Politikası

            </button>

            <button class="legal-tab-btn" data-tab="panel-terms" role="tab" aria-selected="false"

                aria-controls="panel-terms" data-i18n="legal.tab.terms">
        ...
        <div class="legal-panel active" id="panel-privacy" role="tabpanel">

            <h2>🔒 Gizlilik Politikası</h2>

            <span class="legal-date">Son güncelleme: 5 Ağustos 2026</span>

            <div class="legal-content">

                <h3>1. Veri Sorumlusu ve Kapsam</h3>

                <p>Bu Gizlilik Politikası, AVS&amp;V9 bünyesinde geliştirilen ve yayınlanan tüm web siteleri, mobil uygulamalar (Android &amp; iOS platformları) ve bağımsız dijital projeler için geçerlidir. Geliştirici olarak temel ilkemiz, kullanıcılarımızın kişisel verilerinin gizliliğini korumak, şeffaflık sağlamak ve uluslararası veri güvenliği standartlarına tam uyum göstermektir.</p>

                <h3>2. Toplanan Veriler ve Kullanım Amaçları</h3>

                <p>Uygulamalarımızın ve web sitemizin sunduğu hizmet türüne bağlı olarak yalnızca işlevsellik için zorunlu olan minimum seviyede veri işlenmektedir:<br>• <b>Konum Verisi (GPS):</b> V9 Kurye ve Grup Konum uygulamalarımızda harita üzeri canlı takip, rota çizimi ve grup üyelerinin anlık yerini göstermek amacıyla Ön Plan ve Arka Plan konum verisi işlenir.<br>• <b>Cihaz ve Bağlantı Bilgileri:</b> İşletim sistemi sürümü, cihaz modeli ve ağ durumu anonim olarak değerlendirilebilir.<br>• <b>Destek ve İletişim Verileri:</b> İletişim formu üzerinden gönderilen ad, e-posta adresi ve mesaj metinleri yalnızca destek talebinizi yanıtlamak amacıyla kullanılır.</p>

                <h3>3. Üçüncü Taraf Hizmetler ve Google Gizlilik Politikası</h3>

                <p>Projelerimiz; Google Play Hizmetleri, Firebase ve Google Maps servislerini kullanabilir. Google hizmetlerinin verileri nasıl işlediği hakkında daha fazla bilgi edinmek için resmi <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" class="legal-link">Google Gizlilik Politikası (Google Privacy Policy)</a> sayfasını ziyaret edebilirsiniz.</p>

            </div>

            <div class="pd-content-card faq-cta-card" style="margin-top: 30px;">

                <h3 class="faq-cta-title">Yasal Konularda Sorunuz mu Var?</h3>

                <p class="faq-cta-sub">Kişisel veri talepleriniz veya detaylı yasal sorularınız için doğrudan iletişime geçebilirsiniz.</p>
        ...
        <div class="legal-panel" id="panel-terms" role="tabpanel">
            ...
            <div class="legal-content">
                ...
                <h3>1. Hizmet Şartları ve Kabul</h3>

                <p>Bu web sitesini veya AVS&amp;V9 tarafından geliştirilen mobil uygulamaları kullanarak bu Kullanım Koşullarını kabul etmiş sayılırsınız. Şartları kabul etmiyorsanız lütfen uygulamaları ve siteyi kullanmayınız.</p>

                <h3>2. Fikri Mülkiyet Hakları</h3>

                <p>Bu sitede ve uygulamalarda yer alan tüm yazılımlar, tasarım ögeleri, logolar, grafikler, metinler ve kod yapıları AVS&amp;V9'a aittir. İzinsiz kopyalanamaz veya çoğaltılamaz.</p>\n                <h3>3. Kullanım Kuralları ve Yükümlülükler</h3>\n                <p>Kullanıcılar uygulamaları yasalara ve genel ahlak kurallarına uygun olarak kullanacağını taahhüt eder. Tersine mühendislik yapmak veya sisteme zarar vermek yasaktır.</p>\n            </div>\n            <div class="pd-content-card faq-cta-card" style="margin-top: 30px;">\n                <h3 class="faq-cta-title">Yasal Konularda Sorunuz mu Var?</h3>\n                <p class="faq-cta-sub">Kişisel veri talepleriniz veya detaylı yasal sorularınız için doğrudan iletişime geçebilirsiniz.</p>\n                <a href="index.html#iletisim" class="oval-btn pd-cta-btn">Doğrudan İletişime Geçin →</a>\n            </div>\n        </div>\n\n    </main>\n\n    <!-- Footer -->\n    <footer class="site-footer">\n        <div class="footer-inner">\n            <div class="footer-brand">AVS&amp;V9</div>\n            <nav class="footer-links" aria-label="Alt gezinti">\n                <a href="sss.html" data-i18n="nav.faq">SSS</a>\n                <a href="yasal.html" data-i18n="nav.legal">Yasal Bilgiler</a>\n                <a href="index.html#iletisim" data-i18n="nav.contact">İletişim</a>\n            </nav>\n            <div class="footer-social" aria-label="Sosyal Medya Bağlantıları">\n                <a href="#" target="_blank" rel="noopener" aria-label="Instagram" class="footer-social-link">\n                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>\n                </a>\n                <a href="#" target="_blank" rel="noopener" aria-label="TikTok" class="footer-social-link">\n                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>\n                </a>\n                <a href="#" target="_blank" rel="noopener" aria-label="YouTube" class="footer-social-link">\n                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>\n                </a>\n                <a href="#" target="_blank" rel="noopener" aria-label="X" class="footer-social-link">\n                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>\n                </a>\n                <a href="#" target="_blank" rel="noopener" aria-label="Google Play Store" class="footer-social-link">\n                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.28.16.6.24.93.24.4 0 .8-.1 1.15-.32l12.24-7.06-2.85-2.85-11.47 9.99zm-1.18-21.9v20.28c0 .5.15.95.42 1.31l.08.09 11.35-11.35v-.27L2.42.35l-.08.09C2.07.8 2 1.24 2 1.72v.14zM20.9 10.1l-2.46-1.42-3.21 3.21 3.21 3.21 2.48-1.43c.71-.41.71-1.16-.02-1.57zM4.11.56L16.35 7.62 13.5 10.47 2.03 1.48C2.3.93 2.7.56 3.18.32c.28-.16.6-.24.93-.24.4 0 .8.1 1.15.32l-.15.16z"/></svg>\n                </a>\n            </div>\n            <p class="footer-copy" data-i18n="footer.copy">© 2026 AVS&amp;V9 — Tüm hakları saklıdır.</p>\n        </div>\n    </footer>\n\n    <!-- Çerez Banner -->\n    <div class="cookie-banner" id="cookieBanner" role="region" aria-label="Çerez bildirimi">\n        <div class="cookie-inner">\n            <p class="cookie-text" data-i18n="cookie.text">\n                🍪 Bu site, deneyiminizi iyileştirmek için yerel tercih verileri (tema, dil) saklar.\n            </p>\n            <div class="cookie-actions">\n                <button class="cookie-btn cookie-accept" id="cookieAccept" data-i18n="cookie.accept">Kabul Et</button>\n                <a href="yasal.html" class="cookie-btn cookie-settings" data-i18n="cookie.more">Daha Fazla</a>\n            </div>\n        </div>\n</body>\n\n</html>\n                            <h2 class="admin-card-title"><span>📱</span> Proje Seç</h2>\n                        </div>\n                        <div class="admin-project-selector" id="detailProjectSelector">\n                            <!-- JS tarafından doldurulacak -->\n                        </div>\n                    </div>\n\n                    <!-- Detay Editör (Proje seçilince açılır) -->\n                    <div id="detailEditorWrap" style="display:none;">\n\n                        <!-- 2A: Proje Görselleri -->\n                        <div class="admin-card">\n                            <div class="admin-card-header">\n                                <h2 class="admin-card-title"><span>📸</span> Proje Görselleri</h2>\n                                <span style="font-size:0.75rem;color:var(--text-secondary)">Dikey → portre modunda, Yatay → tam genişlik açılır</span>\n                            </div>\n                            <div class="screenshot-grid" id="screenshotGrid"></div>\n                            <label class="admin-upload-area" for="screenshotFileInput">\n                                <div class="upload-icon">📤</div>\n                                <div class="upload-text">\n                                    <strong>Görsel ekle</strong><br>\n                                    PNG, JPG, WebP — Dikey veya Yatay olabilir\n                                </div>\n                                <input type="file" id="screenshotFileInput" accept="image/*" multiple>\n                            </label>\n                        </div>\n\n                        <!-- 2B: Proje Kimliği -->\n                        <div class="admin-card">\n                            <div class="admin-card-header">\n                                <h2 class="admin-card-title"><span>🏷️</span> Proje Kimlik Bilgileri</h2>\n                            </div>\n\n                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">\n                                <div class="admin-form-group">\n                                    <label>Proje Adı (TR)</label>\n                                    <input type="text" id="detailName">\n                                </div>\n                                <div class="admin-form-group">\n                                    <label>Proje Adı (EN)</label>\n                                    <input type="text" id="detailNameEN">\n                                </div>\n                            </div>\n\n                            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">\n                                <div class="admin-form-group">\n                                    <label>Uygulama Boyutu</label>\n                                    <input type="text" id="detailSize" placeholder="~15 MB">\n                                </div>\n                                <div class="admin-form-group">\n                                    <label>Yaş Sınırı</label>\n                                    <input type="text" id="detailAgeRating" placeholder="3+">\n                                </div>\n                            </div>\n\n                            <div class="admin-form-group">\n                                <label>Uygulama Logosu (Dosya yolu veya URL)</label>\n                                <input type="text" id="detailLogo" placeholder="resimler/uygulama_logo.png">\n                            </div>\n                            <div class="admin-form-group">\n                                <label>Kapak Görseli (Proje listesi için)</label>\n                                <input type="text" id="detailThumbnail" placeholder="resimler/projeler-resmi1.jpg">\n                            </div>\n\n                            <!-- Android / Play Store Toggle -->\n                            <div class="admin-toggle-row" id="androidToggleRow">\n                                <div>\n                                    <div class="admin-toggle-label">🤖 Android / Play Store Entegrasyonu</div>\n                                    <div class="admin-toggle-desc">İndirme sayısı, puan, izinler ve Play Store butonu görünsün mü?</div>\n                                </div>\n                                <label class="admin-toggle">\n                                    <input type="checkbox" id="detailIsAndroid">\n                                    <span class="admin-toggle-slider"></span>\n                                </label>\n                            </div>\n\n                            <!-- Play Store Alanları (Android aktifse görünür) -->\n                            <div id="playStoreFields" style="display:none;margin-top:14px;padding-top:14px;border-top:1px solid var(--admin-border);">\n                                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;margin-bottom:14px;">\n                                    <div class="admin-form-group">\n                                        <label>İndirme Sayısı</label>\n                                        <input type="text" id="detailDownloads" placeholder="10B+">\n                                    </div>\n                                    <div class="admin-form-group">\n                                        <label>Puan</label>\n                                        <input type="text" id="detailRating" placeholder="4.8 ★">\n                                    </div>\n                                    <div class="admin-form-group">\n                                        <label>Min. Android</label>\n                                        <input type="text" id="detailMinAndroid" placeholder="Android 8.0 / API 26">\n                                    </div>\n                                </div>\n                                <div class="admin-form-group">\n                                    <label>Play Store Linki</label>\n                                    <input type="url" id="detailPlayStoreUrl" placeholder="https://play.google.com/store/apps/details?id=...">\n                                </div>\n                                <div class="admin-form-group">\n                                    <label>Gerekli İzinler (Her satıra bir izin)</label>\n                                    <textarea id="detailPermissions" rows="4" placeholder="📍 Konum (Ön plan & Arka plan)&#10;🔔 Bildirimler&#10;📶 İnternet Erişimi"></textarea>\n                                </div>\n                            </div>\n                        </div>\n\n                        <!-- 2C: Uygulama Hakkında -->\n                        <div class="admin-card">\n                            <div class="admin-card-header">\n                                <h2 class="admin-card-title"><span>📋</span> Uygulama Hakkında</h2>\n                            </div>\n                            <div class="admin-form-group">\n                                <label>Açıklama (TR) — Her paragraf ayrı satır</label>\n                                <textarea id="detailDescTR" rows="5" placeholder="V9 uygulaması...&#10;&#10;Özellik açıklamaları...&#10;&#10;🚀 Özellik 1 | 💡 Özellik 2"></textarea>\n                            </div>\n                            <div class="admin-form-group">\n                                <label>Açıklama (EN) — Her paragraf ayrı satır</label>\n                                <textarea id="detailDescEN" rows="5" placeholder="V9 app...&#10;&#10;Feature descriptions...&#10;&#10;🚀 Feature 1 | 💡 Feature 2"></textarea>\n                            </div>\n                        </div>\n\n                        <!-- 2D: Sürüm Geçmişi -->\n                        <div class="admin-card">\n                            <div class="admin-card-header">\n                                <h2 class="admin-card-title"><span>📝</span> Sürüm Geçmişi</h2>\n                                <button class="admin-btn admin-btn-primary admin-btn-sm" id="addChangelogBtn">\n                                    ＋ Yeni Sürüm\n                                </button>\n                            </div>\n                            <div class="changelog-list" id="changelogList"></div>\n                        </div>\n\n                        <!-- Detay Kaydet -->\n                        <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:4px;">\n                            <button class="admin-btn admin-btn-primary admin-btn-lg" id="saveDetailBtn">\n                                💾 Değişiklikleri Kaydet\n                            </button>\n                        </div>\n                    </div>\n                </div>\n\n                <!-- ============================================================\n                     SEKME 3: SSS & YASAL SAYFALAR\n                     ============================================================ -->\n                <div class="admin-tab-content" id="tab-sayfalar">\n\n                    <!-- 3A: SSS Yönetimi -->\n                    <div class="admin-card">\n                        <div class="admin-card-header">\n                            <h2 class="admin-card-title"><span>❓</span> SSS Yönetimi</h2>\n                            <button class="admin-btn admin-btn-primary admin-btn-sm" id="addFaqCatBtn">\n                                ＋ Kategori Ekle\n                            </button>\n                        </div>\n                        <div id="faqAdminList"></div>\n                    </div>\n\n                    <!-- SSS Kaydet -->\n                    <div style="display:flex;justify-content:flex-end;margin-bottom:24px;">\n                        <button class="admin-btn admin-btn-primary admin-btn-lg" id="saveFaqBtn">\n                            💾 SSS Kaydet\n                        </button>\n                    </div>\n\n                    <!-- 3B: Gizlilik Politikasıı -->\n                    <div class="admin-card">\n                        <div class="admin-card-header">\n                            <h2 class="admin-card-title"><span>🔏</span> Gizlilik Politikasıı</h2>\n                            <button class="admin-btn admin-btn-sm" id="addPrivacySecBtn">＋ Bölüm Ekle</button>\n                        </div>\n                        <div class="legal-date-row">\n                            <label>Son Güncelleme:</label>\n                            <input type="date" id="privacyDate">\n                            <button class="admin-btn admin-btn-sm" id="setPrivacyTodayBtn">📅 Bugün</button>\n                        </div>\n                        <div id="privacyAdminList"></div>\n                    </div>\n\n                    <!-- 3C: Kullanım Koşulları -->\n                    <div class="admin-card">\n                        <div class="admin-card-header">\n                            <h2 class="admin-card-title"><span>📃</span> Kullanım Koşulları</h2>\n                            <button class="admin-btn admin-btn-sm" id="addTermsSecBtn">＋ Bölüm Ekle</button>\n                        </div>\n                        <div class="legal-date-row">\n                            <label>Son Güncelleme:</label>\n                            <input type="date" id="termsDate">\n                            <button class="admin-btn admin-btn-sm" id="setTermsTodayBtn">📅 Bugün</button>\n                        </div>\n                        <div id="termsAdminList"></div>\n                    </div>\n\n                    <!-- Yasal Kaydet -->\n                    <div style="display:flex;justify-content:flex-end;gap:12px;margin-top:4px;">\n                        <button class="admin-btn admin-btn-primary admin-btn-lg" id="saveLegalBtn">\n                            💾 Yasal Sayfaları Kaydet\n                        </button>\n                    </div>\n                </div>\n\n                <!-- ============================================================\n                     SEKME 4: SOSYAL MEDYA YÖNETİMİ\n                     ============================================================ -->\n                <div class="admin-tab-content" id="tab-sosyal">\n                    <div class="admin-card">\n                        <div class="admin-card-header">\n                            <div>\n                                <h2 class="admin-card-title">\n                                    <span>📲</span> Sosyal Medya Akış Yönetimi\n                                </h2>\n                                <p style="font-size:0.8rem;color:var(--text-secondary);margin:4px 0 0;">\n                                    Instagram, TikTok, YouTube ve X (Twitter) hesaplarından güncel paylaşımlar.\n                                </p>\n                            </div>\n                            <button class="admin-btn admin-btn-primary admin-btn-lg" id="fetchSocialFeedBtn">\n                                🔄 Rastgele Gönderi Çek / Yenile\n                            </button>\n                        </div>\n\n                        <div style="padding:12px 16px;background:rgba(255,71,87,0.06);border:1px solid var(--admin-border);border-radius:12px;margin-bottom:20px;font-size:0.82rem;color:var(--text-secondary);">\n                            💡 <strong>Overwriting Kuralı:</strong> Her yenilemede yeni gönderiler eskilerinin üzerine yazılır. Böylece sunucuda gereksiz dosya veya içerik birikmesi tamamen önlenir. Videoların sadece kapak görselleri çekilir.\n                        </div>\n\n                        <div class="admin-card-header" style="margin-bottom:12px;">\n                            <span style="font-size:0.85rem;font-weight:700;color:var(--admin-accent);" id="socialLastUpdatedLabel">\n                                Son Güncelleme: -\n                            </span>\n                        </div>\n\n                        <div class="slider-img-grid" id="socialAdminList" style="grid-template-columns: repeat(auto-fill, minmax(230px, 1fr));">\n                            <!-- JS tarafından doldurulacak -->\n                        </div>\n                    </div>\n                </div>\n\n            </div><!-- /admin-container -->\n        </div><!-- /admin-page -->\n\n        <!-- KAYDET BARRI (Alt) -->\n        <div class="admin-save-bar" id="adminSaveBar">\n            <div class="admin-save-bar-text">Kaydedilmemiş değişiklikler var</div>\n            <div class="admin-save-actions">\n                <button class="admin-btn admin-btn-sm" id="discardChangesBtn">İptal</button>\n                <button class="admin-btn admin-btn-primary admin-btn-sm" id="saveAllBtn">💾 Hepsini Kaydet</button>\n            </div>\n        </div>\n\n    </div><!-- /adminPanel -->\n\n    <!-- ======= MODALLER ======= -->\n\n    <!-- Proje Ekle/Düzenle Modal -->\n    <div class="verification-modal" id="projectModal" aria-hidden="true" inert>\n        <div class="verification-card" role="dialog" style="max-width:520px;width:95%;border:1.5px solid var(--admin-border);max-height: 90vh;overflow-y: auto;">\n            <h3 id="projectModalTitle" style="color:var(--admin-accent);margin:0 0 20px;">Proje Ekle</h3>\n            <div style="display:grid;gap:12px;">\n                <div class="admin-form-group">\n                    <label>Proje Adı (TR)</label>\n                    <input type="text" id="pmName" placeholder="V9 Uygulama Adı">\n                </div>\n                <div class="admin-form-group">\n                    <label>Proje Adı (EN)</label>\n                    <input type="text" id="pmNameEN" placeholder="V9 App Name">\n                </div>\n                <div class="admin-form-group">\n                    <label>Kısa Açıklama (TR)</label>\n                    <textarea id="pmDesc" rows="2" placeholder="Kısa açıklama..."></textarea>\n                </div>\n                <div class="admin-form-group">\n                    <label>Slug (URL kısmı)</label>\n                    <input type="text" id="pmSlug" placeholder="yeni-proje">\n                </div>\n                <div class="admin-form-group">\n                    <label>Durum</label>\n                    <div id="pmStatusContainer" style="display:flex; flex-direction:column; gap:8px;"></div>\n                    <button type="button" class="admin-btn admin-btn-sm" id="pmAddStatusBtn" style="margin-top:8px;">➕ Yeni Durum Ekle</button>\n                </div>\n                <div class="admin-form-group">\n                    <label>Etiketler (virgülle ayrılmış)</label>\n                    <input type="text" id="pmTags" placeholder="📱 Mobil, 🗺️ Harita">\n                </div>\n                <div class="admin-form-group">\n                    <label>Kapak Görseli URL veya Dosya Yolu</label>\n                    <input type="text" id="pmThumbnail" placeholder="resimler/proje-kapak.jpg">\n                </div>\n                <div class="admin-form-group" style="margin-top:-8px;">\n                    <label>veya Dosyadan Yükle</label>\n                    <label class="admin-upload-area" for="pmThumbnailFile" style="padding:16px 20px;">\n                        <div class="upload-icon" style="font-size:1.6rem;margin-bottom:4px;">📤</div>\n                        <div class="upload-text" style="font-size:0.78rem;">Kapak görseli seç (16:9 önerilen)</div>\n                        <input type="file" id="pmThumbnailFile" accept="image/*">\n                    </label>\n                </div>\n            </div>\n            <div class="verification-actions" style="margin-top:20px;">\n                <button class="verify-btn" id="projectModalSave" style="background:var(--admin-accent);">💾 Kaydet</button>\n                <button class="cancel-btn" id="projectModalCancel">İptal</button>\n            </div>\n        </div>\n    </div>\n\n    <!-- Sürüm Ekle/Düzenle Modal -->\n    <div class="verification-modal" id="changelogModal" aria-hidden="true" inert>\n        <div class="verification-card" role="dialog" style="max-width:480px;width:95%;border:1.5px solid var(--admin-border);">\n            <h3 id="changelogModalTitle" style="color:var(--admin-accent);margin:0 0 20px;">Sürüm Ekle</h3>\n            <div style="display:grid;gap:12px;">\n                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">\n                    <div class="admin-form-group">\n                        <label>Versiyon No</label>\n                        <input type="text" id="clVersion" placeholder="v1.0.2">\n                    </div>\n                    <div class="admin-form-group">\n                        <label>Tarih</label>\n                        <input type="date" id="clDate">\n                    </div>\n                </div>\n                <div class="admin-form-group">\n                    <label>Sürüm Türü</label>\n                    <select id="clType">\n                        <option value="major">🔴 Major (Büyük Güncelleme)</option>\n                        <option value="minor">🔵 Minor (Küçük Güncelleme)</option>\n                        <option value="fix">🟢 Fix (Hata Düzeltme)</option>\n                        <option value="feature">🟣 Özellik Eklemesi</option>\n                        <option value="initial">🟡 İlk Sürüm</option>\n                    </select>\n                </div>\n                <div class="admin-form-group">\n                    <label>Değişiklikler (Her satıra bir madde)</label>\n                    <textarea id="clNotes" rows="5" placeholder="Yeni özellik eklendi&#10;Hata düzeltildi&#10;Performans iyileştirildi"></textarea>\n                </div>\n            </div>\n            <div class="verification-actions" style="margin-top:20px;">\n                <button class="verify-btn" id="changelogModalSave" style="background:var(--admin-accent);">💾 Kaydet</button>\n                <button class="cancel-btn" id="changelogModalCancel">İptal</button>\n            </div>\n        </div>\n    </div>\n\n    <!-- SSS Madde Ekle Modal -->\n    <div class="verification-modal" id="faqItemModal" aria-hidden="true" inert>\n        <div class="verification-card" role="dialog" style="max-width:480px;width:95%;border:1.5px solid var(--admin-border);">\n            <h3 id="faqItemModalTitle" style="color:var(--admin-accent);margin:0 0 20px;">SSS Madde Ekle</h3>\n            <div style="display:grid;gap:12px;">\n                <div class="admin-form-group">\n                    <label>Soru</label>\n                    <input type="text" id="faqQ" placeholder="Uygulama neden...?">\n                </div>\n                <div class="admin-form-group">\n                    <label>Cevap</label>\n                    <textarea id="faqA" rows="4" placeholder="Açıklama metni..."></textarea>\n                </div>\n            </div>\n            <div class="verification-actions" style="margin-top:20px;">\n                <button class="verify-btn" id="faqItemSave" style="background:var(--admin-accent);">💾 Kaydet</button>\n                <button class="cancel-btn" id="faqItemCancel">İptal</button>\n            </div>\n        </div>\n    </div>\n\n    <!-- SortableJS (Drag & Drop Sıralama için) -->\n    <script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>\n    <script src="script.js" defer></script>\n    <script src="admin.js" defer></script>\n\n    <!-- LiGHTBOX -->\n    <div class="admin-lightbox" id="adminLightbox">\n        <img id="adminLightboxImg" src="" alt="">\n        <button class="admin-lightbox-close" id="adminLightboxClose">×</button>\n    </div>\n\n</body>\n\n</html>\n\n  }\n};\nwindow.EMBEDDED_TRANSLATIONS = {\n  "tr": {\n    "nav.home": "Ana Sayfa",\n    "nav.projects": "Projelerim",\n    "nav.about": "Hakkında",\n    "nav.contact": "İletişim",\n    "nav.faq": "SSS",\n    "nav.legal": "Yasal",\n    "hero.title": "HOŞGELDİN YOLCU",\n    "hero.subtitle": "Basit ama etkili yazılımlar, kullanıcı dostu deneyimler ve modern çözümlerle yolculuğumuza devam ediyoruz.",\n    "hero.scroll": "Aşağı Kaydır",\n    "projects.title": "Projelerim",\n    "projects.intro": "Kullanıcı deneyimini ön planda tutan, sade tasarımlı ve işlevsel çözümler geliştirmeye odaklanıyorum.",\n    "about.title": "Hakkında",\n    "about.intro": "Projelerim, teknik beceri ve kullanıcı odaklı düşünce yapısının birleşimiyle ortaya çıkıyor.",\n    "about.body1": "Teknolojiye duyduğum merak ve kişisel gelişim amacıyla başlayan bu yolculuk, bugün daha büyük hedeflere hizmet eden, sürdürülebilir ve güçlü projelere dönüştü. Sektör deneyimim, farklı bakış açılarım ve sürekli öğrenme tutkum, geliştirdiğim her çözümün temelini oluşturuyor.",\n    "about.body2": "Amacım, karmaşık görünen fikirleri basit, hızlı ve etkili dijital deneyimlere dönüştürmek. Her proje, kullanıcıyla olan bağı güçlendiren ve gerçek bir ihtiyaca çözüm sunan bir yaklaşımla inşa ediliyor.",\n    "about.skills": "💻 Beceriler & Uzmanlık Alanları",\n    "contact.title": "İletişim",\n    "contact.intro": "Projeler, fikirler veya işbirlikleri hakkında konuşmak isterseniz, bir mesaj bırakın.",\n    "contact.name": "Adınız",\n    "contact.email": "E-posta Adresiniz",\n    "contact.message": "Mesajınız",\n    "contact.send": "Mail Gönder",\n    "detail.about": "📋 Uygulama Hakkında",\n    "detail.requirements": "📱 Sistem Gereksinimleri",\n    "detail.permissions": "🔐 Gerekli İzinler",\n    "detail.changelog": "📝 Sürüm Geçmişi",\n    "detail.getapp": "Google Play'den İndir",
...
// --- GV-3: XSS KORUMA YARDIMCISI ---------------------------------------------
// JSON'dan gelen tm ierikler bu fonksiyondan geirilir.
...
// Tek interval kaydedici  ift setInterval bellek szntsn nler.
...
// --- KOD-1: DUPLKE FONKSYONLAR KALDIRILDI ---------------------------------
// (Tm fonksiyonlarn tek ve doru versiyonlar aada tanmlanmtr)

// Durum etiketi CSS snf ve metnini dndrr
function getStatusTag(status) {
    const map = {
        'live':         { cls: 'tag-live',      text: '\U0001f7e2 Yay\u0131nda' },
        ...
        'research':     { cls: 'tag-wip',       text: '\U0001f50d Ara\u015ft\u0131rma A\u015famas\u0131nda' },
        'bugfix':       { cls: 'tag-wip',       text: '\U0001f6e0\ufe0f Hata D\xfczeltme' },
        'waiting':      { cls: 'tag-soon',      text: '\u23f1 Beklemede' },
        'special':      { cls: 'tag-wip',       text: '\u2b50 \xd6zel Durum' },
        'rnd':          { cls: 'tag-wip',       text: '\U0001f9ea Ar-Ge A\u015famas\u0131nda' }
    };
...
// ===============================================================================
// DNAMK VER FONKSYONLARI  site-data.json zerinden ierik gncelleme
// ===============================================================================
...
// KOD-4: img tag kullanlyor (div+backgroundImage kaldrld)  eriilebilir ve SEO dostu.
function initDynamicHeroSlider(data) {
    ...
    // PERF-3: Yeni slaytlarla tek bir interval balat
        ...
        <a href="proje-detay.html?p=${sanitize(p.slug)}" class="project-oval-box scroll-anim" aria-label="${sanitize(name)} Detaylar\u0131">
            ...
            <div class="project-oval-info">
                ...
                <div class="project-oval-tags">
                    ${statusHTML}
                    ${extraTags.map(t => `<span class="tag">\U0001f4cc ${sanitize(t)}</span>`).join('')}
                </div>
            </div>
            ...
            <div class="sm-slide">
                ...
                <div class="sm-slide-body">
                    ...
                    <a href="${sanitize(p.postUrl)}" class="sm-slide-btn" target="_blank" rel="noopener noreferrer">
                        ${(lang === 'en' ? 'View Post \u2197' : 'G\xf6nderiyi \u0130ncele \u2197')}
                    </a>
                </div>
            </div>
        `;
...
function initDynamicFaq(data) {
    ...
    // Mevcut SSS gruplarn ve balklarn temizle
    ...
    const ctaBtn = lang === 'en' ? 'Contact Directly \u2192' : 'Do\u011frudan \u0130leti\u015fime Ge\xe7in \u2192';
    cta.innerHTML = `
...
function initDynamicLegal(data) {
    ...
    // Cta Kart HTML ablonu
    const ctaTitle = lang === 'en' ? 'Have Questions or Legal Inquiries?' : 'Yasal Konularda Sorunuz mu Var?';
    const ctaSub = lang === 'en' ? 'For data privacy requests or detailed inquiries, you can contact the developer directly.' : 'Ki\u015fisel veri talepleriniz veya detayl\u0131 yasal sorular\u0131n\u0131z i\xe7in do\u011frudan ileti\u015fime ge\xe7ebilirsiniz.';
    const ctaBtn = lang === 'en' ? 'Contact Directly \u2192' : 'Do\u011frudan \u0130leti\u015fime Ge\xe7in \u2192';
    const ctaHtml = `
        <div class="pd-content-card faq-cta-card" style="margin-top: 30px;">
            <h3 class="faq-cta-title">${sanitize(ctaTitle)}</h3>
    ...
    if (privSec && legal.privacy) {
        ...
        if (dateEl && legal.privacy.lastUpdated) dateEl.textContent = (lang === 'en' ? `Last updated: ` : `Son g\xfcncelleme: `) + legal.privacy.lastUpdated;
    ...
    if (termsSec && legal.terms) {
        ...
        if (dateEl && legal.terms.lastUpdated) dateEl.textContent = (lang === 'en' ? `Last updated: ` : `Son g\xfcncelleme: `) + legal.terms.lastUpdated;
...
// Tercihleri annda balat (HTML render aamasnda renk yanp snmesin)
(function () {
...
// --- DOM HAZIR OLUNCA ALIACAK TM DNLEYCLER ---
function initApp() {
    loadTranslations(); // TRANSLATIONS'i y\xfckle
    // --- DNAMK VER YKLEME (site-data.json) -------------------------------
    // Admin panelinden yaplan deiiklikler burada okunur ve sayfalar gncellenir.
    // Admin paneli sayfasnda bu blok almaz (data-admin-page kontrol).
    ...
    function validateName() {
        ...
        setFieldState(nameField, nameHint, true, '\u2713 G\xfczel!');
        return true;
    }
    ...
    function validateEmail() {
        ...
        if (!emailRegex.test(val)) { setFieldState(emailField, emailHint, false, 'Ge\xe7erli bir e-posta adresi girin.'); return false; }
        setFieldState(emailField, emailHint, true, '\u2713 E-posta adresi ge\xe7erli.');
        return true;
    }
    ...
    // --- DRY MATEMATK CAPTCHA YARDIMCISI ---
        ...
        if (inputEl) {
            inputEl.addEventListener('input', () => {
                ...
                if (val === correctAnswer) {
                    ...
                    if (statusEl) statusEl.textContent = '\u2713 Do\u011fru! Y\xf6nlendiriliyorsunuz...';
                    isVerified = true;
    ...
    function completeVerification() {
        ...
        if (contactStatus) {
            // KOD-3: innerHTML kullan ama onclick YOK  aada addEventListener ile balan
            contactStatus.innerHTML = `
                <div class="mail-success-card">
                    <p class="mail-success-title">\u2705 G\xfcvenlik Do\u011frulamas\u0131 Ba\u015far\u0131l\u0131!</p>
                    <p class="mail-success-sub">Mesaj\u0131n\u0131z e-posta istemcinize aktar\u0131ld\u0131. Otomatik a\xe7\u0131lmad\u0131ysa a\u015fa\u011f\u0131daki butona basabilir veya adrese do\u011frudan mail atabilirsiniz:</p>
                    <div class="mail-success-actions">
                        <a href="${mailtoUrl}" class="mail-direct-btn">\u2709\ufe0f E-postay\u0131 G\xf6nder (${rawEmail})</a>
            ...
            if (copyBtn) {
                copyBtn.addEventListener('click', () => {
                    navigator.clipboard.writeText(rawEmail).then(() => {
                        ...
                        copyBtn.textContent = rawEmail; // Fallback: metni g\xf6ster
                    });
                });
            }
        }
    ...
    if (verifyButton) verifyButton.addEventListener('click', () => { if (contactCaptcha.isVerified()) completeVerification(); else if (captchaStatus) captchaStatus.textContent = 'L\xfctfen soruyu do\u011fru cevaplay\u0131n.'; });
    ...
    if (contactButton) {
        contactButton.addEventListener('click', () => {
            ...
            if (!nameOk && contactNameInput && contactNameInput.value.trim().length === 0)
                setFieldState(nameField, nameHint, false, 'L\xfctfen ad\u0131n\u0131z\u0131 girin.');
            if (!emailOk && contactEmailInput && contactEmailInput.value.trim().length === 0)
                setFieldState(emailField, emailHint, false, 'L\xfctfen e-posta adresinizi girin.');
            if (!messageOk && contactMessageInput && contactMessageInput.value.trim().length === 0)
                setFieldState(messageField, messageHint, false, 'L\xfctfen mesaj\u0131n\u0131z\u0131 girin.');

            if (nameOk && emailOk && messageOk) openVerificationModal();
        });
    }

    // --- BENTO KART TIKLAMALARI VE KLAVYE ERLEBLRL ---
    document.addEventListener('click', e => {
...
function initProjectDetail(proj) {
    ...
    if (permEl) {
        if (permsArr.length > 0) {
            permEl.innerHTML = permsArr.map(p => `<span class="pd-tag">\U0001f4cc ${escapeHTML(p)}</span>`).join('');
        } else {
            permEl.innerHTML = `<span class="pd-tag">${lang === 'en' ? 'No special permissions required' : '\xd6zel izin gerektirmez'}</span>`;
        }
    }
    ...
    if (changelogEl) {
        if (clData && clData.length > 0) {
            changelogEl.innerHTML = clData.map(c => {
                ...
                const featStr = features.length ? `<p class="cl-subtitle">\u2728 ${lang === 'en' ? 'New Features' : 'Yeni \xd6zellikler'}</p><ul>${features.map(f => `<li>${escapeHTML(f)}</li>`).join('')}</ul>` : '';
                const bugStr = fixes.length ? `<p class="cl-subtitle">\U0001f41b ${lang === 'en' ? 'Bug Fixes' : 'Hata D\xfczeltmeleri'}</p><ul>${fixes.map(f => `<li>${escapeHTML(f)}</li>`).join('')}</ul>` : '';
                return `
                <div class="faq-item">
                    <button class="faq-question">
            ...
            changelogEl.innerHTML = `<p style="color:var(--text-secondary); padding: 12px 0;">${lang === 'en' ? 'No release history published for this project yet.' : 'Bu proje i\xe7in hen\xfcz s\xfcr\xfcm ge\xe7mi\u015fi yay\u0131nlanmad\u0131.'}</p>`;
        }
    }
    ...
    if (pdAppSlider && slides && slides.length > 0) {
        pdAppSlider.innerHTML = slides.map((src, i) =>
            `<div class="pd-app-slide${i === 0 ? ' active' : ''}">
               <img src="${src}" alt="${escapeHTML(name)} Screen ${i + 1}" loading="${i === 0 ? 'eager' : 'lazy'}" title="${lang === 'en' ? 'Click to zoom' : 'B\xfcy\xfctmek i\xe7in t\u0131klay\u0131n'}">
             </div>`
        ).join('');
    }
}
    ...
    function completePdVerify() {
        ...
        const mailtoUrl = `mailto:${atob('YWd2cnNwLnY5QGdtYWlsLmNvbQ==')}?subject=${encodeURIComponent(`[AVS&V9 - ${subj.toUpperCase()}] ${name}`)}&body=${encodeURIComponent(`G\xf6nderen: ${name}\nE-posta: ${email}\n\nMesaj:\n${msg}`)}`;
        ...
        if (pdStatus) {
            ...
            pdStatus.innerHTML = `
                <div style="background: rgba(0,173,181,0.08); border: 1px solid var(--accent-color); border-radius: 16px; padding: 16px; margin-top: 14px; text-align: left;">
                    <p style="margin: 0 0 8px; color: var(--accent-color); font-weight: 700;">\u2713 E-posta istemciniz a\xe7\u0131ld\u0131!</p>
                    <p style="margin: 0 0 8px; font-size: 0.85rem; color: var(--text-secondary);">A\xe7\u0131lmad\u0131ysa do\u011frudan e-posta atabilirsiniz: <strong>${atob('YWd2cnNwLnY5QGdtYWlsLmNvbQ==')}</strong></p>
    ...
    if (pdSendBtn) {
        pdSendBtn.addEventListener('click', () => {
            ...
            if (!name || !email || !msg) {
                if (pdStatus) {
                    pdStatus.style.display = 'block';
                    pdStatus.innerHTML = `<span style="color: #e74c3c;">L\xfctfen t\xfcm gerekli alanlar\u0131 (Ad, E-posta, Mesaj) doldurun.</span>`;
                }
                return;
            }
    ...
    if (pdVerifyBtn) {
        pdVerifyBtn.addEventListener('click', () => {
            ...
            else if (pdCapStatus) pdCapStatus.textContent = 'L\xfctfen soruyu do\u011fru cevaplay\u0131n.';
        });
    }
